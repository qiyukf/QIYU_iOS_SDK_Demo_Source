...
@implementation QYBadgeView

+ (instancetype)viewWithBadgeTip:(NSString *)badgeValue {
    if (!badgeValue) {
        badgeValue = @"";
    }
    QYBadgeView *instance = [[QYBadgeView alloc] init];
...
- (CGRect)frameWithStr:(NSString *)badgeValue {
    ...
    CGRect badgeFrame = CGRectMake(self.frame.origin.x,
                                   ...
                                   badgeSize.height + self.badgeTopPadding * 2 + self.whiteCircleWidth * 2);
    return badgeFrame;
}
