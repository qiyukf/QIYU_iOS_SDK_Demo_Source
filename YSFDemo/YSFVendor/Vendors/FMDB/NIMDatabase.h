...
typedef int(^YSF_NIMDBExecuteStatementsCallbackBlock)(NSDictionary *resultsDictionary);
...
@interface YSF_NIMDatabase : NSObject  {
...
- (BOOL)executeStatements:(NSString *)sql withResultBlock:(YSF_NIMDBExecuteStatementsCallbackBlock)block;
...
- (YSF_NIMResultSet *)executeQuery:(NSString*)sql, ...;
...
- (YSF_NIMResultSet *)executeQueryWithFormat:(NSString*)format, ... NS_FORMAT_FUNCTION(1,2);
...
- (YSF_NIMResultSet *)executeQuery:(NSString *)sql withArgumentsInArray:(NSArray *)arguments;
...
- (YSF_NIMResultSet *)executeQuery:(NSString *)sql withParameterDictionary:(NSDictionary *)arguments;


// Documentation forthcoming.
- (YSF_NIMResultSet *)executeQuery:(NSString*)sql withVAList: (va_list)args;
...
@interface YSF_NIMStatement : NSObject {
