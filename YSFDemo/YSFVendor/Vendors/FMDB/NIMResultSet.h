...
@class YSF_NIMDatabase;
@class YSF_NIMStatement;
...
@interface YSF_NIMResultSet : NSObject {
    YSF_NIMDatabase          *_parentDB;
    YSF_NIMStatement         *_statement;
...
@property (atomic, retain) YSF_NIMStatement *statement;
...
+ (instancetype)resultSetWithStatement:(YSF_NIMStatement *)statement usingParentDatabase:(YSF_NIMDatabase*)aDB;

/** Close result set */

- (void)close;

- (void)setParentDB:(YSF_NIMDatabase *)newDb;
