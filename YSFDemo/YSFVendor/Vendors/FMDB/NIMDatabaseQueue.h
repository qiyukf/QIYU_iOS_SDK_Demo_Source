...
@interface YSF_NIMDatabaseQueue : NSObject {
    NSString            *_path;
...
- (void)inDatabase:(void (^)(YSF_NIMDatabase *db))block;
...
- (void)inTransaction:(void (^)(YSF_NIMDatabase *db, BOOL *rollback))block;
...
- (void)inDeferredTransaction:(void (^)(YSF_NIMDatabase *db, BOOL *rollback))block;
...
- (NSError*)inSavePoint:(void (^)(YSF_NIMDatabase *db, BOOL *rollback))block;
#endif
