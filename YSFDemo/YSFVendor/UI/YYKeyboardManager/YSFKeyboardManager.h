//
//  YSFKeyboardManager.h
//  YSFKit <https://github.com/ibireme/YSFKit>
//
...
#if __has_include(<YSFKeyboardManager/YSFKeyboardManager.h>)
FOUNDATION_EXPORT double YSFKeyboardManagerVersionNumber;
FOUNDATION_EXPORT const unsigned char YSFKeyboardManagerVersionString[];
#endif
...
/**
 ...
 Use -[YSFKeyboardManager convertRect:toView:] to convert frame to specified view.
 */
typedef struct {
...
} YSFKeyboardTransition;


/**
 The YSFKeyboardObserver protocol defines the method you can use
 to receive system keyboard change information.
 */
@protocol YSFKeyboardObserver <NSObject>
@optional
...
/**
 A YSFKeyboardManager object lets you get the system keyboard information,
 ...
 */
@interface YSFKeyboardManager : NSObject
 ...
 */
- (void)addObserver:(id<YSFKeyboardObserver>)observer;
 ...
 */
- (void)removeObserver:(id<YSFKeyboardObserver>)observer;
